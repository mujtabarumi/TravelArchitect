                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Edit Popular City</h3>
                        </div>

                        <div class="card-body">

                            <form method="post" action="{{route('popularcity.update')}}" enctype="multipart/form-data">
                                {{csrf_field()}}
                                <input type="hidden" value="{{$popularcity->id}}" name="popularcityid">
...
@section('js')
    ...
    <script>
      ...
      //  $('#city').select2('val', '6099').trigger('change');
    </script>
